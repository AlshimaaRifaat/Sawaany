...
import kotlinx.android.synthetic.main.activity_navigation_home.*

class NavigationHomeActivity : AppCompatActivity(),NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        menuInflater.inflate(R.menu.navigation_home, menu)
        return true
    }
